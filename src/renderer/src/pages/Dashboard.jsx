...
//           dispatch(getUserPermissionsSlice(session.user.id))
//         }
//       } catch (error) {
...
//   const handleLogout = () => {
//     window.api.removeUserSession()
//     window.location.href = '#/login'
//   }

//   // Helper function to check if user has permission by name
//   const hasPermission = (permissionName) => {
//     if (!userPermissions || userPermissions.length === 0) return false
//     return userPermissions.some(p => p.name === permissionName)
//   }

//   // Define all menu items with their required tab permissions
//   const allMenuItems = [
//     {
//       title: 'Sales',
//       icon: saleIcon,
...
//       // Only include menu if user has at least one child permission
...
//         {/* Show "No permissions" message if loaded but empty */}
//         {permissionsLoaded && menuItems.length === 0 && (
//           <div className="text-center text-sm text-gray-300 p-4 bg-red-900/20 rounded">
//             No permissions assigned. Please contact your administrator.
//           </div>
//         )}

//         {/* MENU ITEMS - Only show when loaded */}
...
//                 {isSidebarOpen && (
//                   <span className="text-2xl font-extrabold">{openMenu === index ? '−' : '+'}</span>
//                 )}
//               </div>
